...
byte currentONM1[4]={0,0,30,0}; // proud ON na motoru 1 - motor1 je slabší -- puvodne 2byte 11 1byte 135
byte currentONM2[4]={0,0,30,0}; // proud ON na motoru 2 - motor2 je silnější --puvodne 2byte 15 1byte 135
...
int RPMMAX1 = 160; // maximánlní povolené otáčky za minutu  // puvodne --- 400
int RPMMIN1 = 155; // minimánlní povolené otáčky za minutu  // puvodne --- 390
int RPMMAX2 = 160; // maximánlní povolené otáčky za minutu // puvodne --- 1000
int RPMMIN2 = 155; // minimánlní povolené otáčky za minutu // puvodne --- 990
