...
const int out12V_0 = 3;
const int out12V_1 = 4;
const int out12V_2 = 5;
...
void setup() {
  ...
  pinMode(out12V_0,OUTPUT); //syrena
  pinMode(out12V_1,OUTPUT); //syrena
  pinMode(out12V_2,OUTPUT); //syrena
  
  digitalWrite(ledPin, LOW);
  digitalWrite(Syrena, LOW);
  digitalWrite(out12V_0, LOW);
  digitalWrite(out12V_1, LOW);
  digitalWrite(out12V_2, LOW);
