...
ssh k2jetson_front -t "screen -dm python3 git/kloubak/system/launcher_jetson.py && sleep 2"
ssh k2jetson_rear -t "sudo date +%c -s '$(date +%c)'"
ssh k2jetson_rear -t "screen -dm python3 git/kloubak/system/launcher_jetson.py && sleep 2"
