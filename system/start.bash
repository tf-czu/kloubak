...
ssh k2jetson_front -t "screen -dmL python3 git/kloubak/system/launcher_jetson.py"
ssh k2jetson_rear -t "sudo date +%c -s '$(date +%c)'"
ssh k2jetson_rear -t "screen -dmL python3 git/kloubak/system/launcher_jetson.py"
